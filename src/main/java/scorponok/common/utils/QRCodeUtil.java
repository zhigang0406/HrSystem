...
public class QRCodeUtil {
	 ...
	 */
	public static BufferedImage createImage(String content, String logoImgPath, boolean needCompress)
	...
	public static void main(String[] args) throws WriterException, IOException {
		BufferedImage img = QRCodeUtil.createImage("http://www.baidu.com", null, false);
		ImageIO.write(img, "png", new FileOutputStream(new File("d://text.png")));
	}
